...
export async function generateSingleIssuePdf(issue: any) {
    try {
        await fetch('http://217.154.85.189:4000/v1/pdf/gen_single_issue/', {
            method: 'POST',
            headers: {
            ...
            vscode.env.openExternal(vscode.Uri.parse("http://217.154.85.189:4000/v1/pdf/" + data.pdf_path));
        });
    } catch (error) {
...
export async function generateProjectPdf(issues: any, project: any) {
    try {
        await fetch('http://217.154.85.189:4000/v1/pdf/gen_project/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export async function generateAuditPdf(issues: any) {
    try {
        await fetch('http://217.154.85.189:4000/v1/pdf/gen_audit/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },

...
export async function generateSingleIssuePdf(issue: any) {
    try {
        await fetch('http://localhost:4000/v1/pdf/gen_single_issue/', {
            method: 'POST',
            headers: {
...
export async function generateProjectPdf(issues: any, project: any) {
    try {
        await fetch('http://localhost:4000/v1/pdf/gen_project/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export async function generateAuditPdf(issues: any) {
    try {
        await fetch('http://localhost:4000/v1/pdf/gen_audit/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },

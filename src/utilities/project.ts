...
export function createProject(projectName: string, userToken: string) {
    return fetch('http://192.168.178.52:4000/v1/projects/create', {
        method: 'POST',
        headers: {
...
export function getProjects(userToken: string) {
    return fetch(`http://192.168.178.52:4000/v1/projects/all/${userToken}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        }
...
export function getProject(projectUuid: string) {
    return fetch(`http://192.168.178.52:4000/v1/projects/${projectUuid}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        }
...
export function deleteProject(projectUuid: string) {
    return fetch(`http://192.168.178.52:4000/v1/projects/${projectUuid}/delete`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        }
...
export function addUser(projectUuid: string, userUuid: string) {
    return fetch(`http://192.168.178.52:4000/v1/projects/${projectUuid}/add_member`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
export function deleteUser(memberUuid: string) {
    return fetch(`http://192.168.178.52:4000/v1/projects/${memberUuid}/delete_member`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        }
...
export function addIssue(projectUuid: string, userToken: string, auditResults: AuditResults) {
    ...
    return fetch(`http://192.168.178.52:4000/v1/projects/${projectUuid}/add_issue`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
export function deleteIssue(issueUuid: string) {
    return fetch(`http://192.168.178.52:4000/v1/issues/${issueUuid}/delete`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        }
